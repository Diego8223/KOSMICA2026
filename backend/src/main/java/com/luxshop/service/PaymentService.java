...
public class PaymentService {
    ...
    public Map<String, String> createNequiPayment(
        ...
        try {
            ...
            // Causa 1: número no registrado en Nequi o formato incorrecto
            if (apiBody.contains("phone") || apiBody.contains("E301")
                    || apiBody.contains("invalid_number") || apiBody.contains("user not found")) {
                throw new RuntimeException(
                    "El número " + cleanPhone + " no está registrado en Nequi o es inválido.");
            }
